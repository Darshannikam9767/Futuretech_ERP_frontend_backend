...
<head>
    ...
    <title>Futuretech software training institute | Admin Login</title>
   <link rel="stylesheet" href="Assets/Admin_css/admin_authentication.css">
    <link rel="shortcut icon" href="Assets/images/logo.png" type="image/x-icon">
</head>

<body>

    <div class="Admin_authentication">
        <div id="login_section">
            <div class="student_btn">
                <button id="login_as_student">Student Login</button>
            </div>
	...
	const login_as_student = document.getElementById('login_as_student');
	...
	forget_password.addEventListener('click', () => {
	    window.location.href = "admin_authentication.jsp?view=forget";
	});

	back_to_login.addEventListener('click', () => {
	    window.location.href = "admin_authentication.jsp?view=login";
	});

	login_as_student.addEventListener('click', () => {
